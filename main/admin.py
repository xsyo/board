...
def send_activation_notifications(modeladmin, request, queryset):
    ...
    modeladmin.message_user(request, 'Письма с оповещянием отправлены')
send_activation_notifications.short_description = 'Отправка письма с оповещянием об активации'
...
class CommentAdmin(admin.ModelAdmin):
    list_display = ('bb', 'author', 'content', 'created_at', 'is_active')
